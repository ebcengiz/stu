  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-3 backdrop-blur-[2px]" onClick={onClose}>
      <div
        ...
        aria-modal="true"
      >
        <div className="flex items-center justify-between bg-gradient-to-r from-emerald-600 to-teal-700 px-4 py-3">
        ...
        <form onSubmit={submit} className="space-y-4 p-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700">Proje adı</label>
            <input
              required
              value={form.name}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700">Proje açıklama</label>
            <textarea
              rows={4}
          ...
          <div className="flex flex-wrap justify-end gap-2 border-t border-gray-100 pt-4">
            <button
              type="button"
              onClick={onClose}
              className="inline-flex items-center gap-1.5 rounded-lg border border-orange-200 bg-orange-500 px-4 py-2 text-sm font-semibold text-white hover:bg-orange-600"
            >
              <X className="h-4 w-4" />
              Vazgeç
            </button>
