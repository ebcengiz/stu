    ...
    <div className="mx-auto w-full min-w-0 max-w-full space-y-6 overflow-x-hidden pb-8">
      <div className="overflow-hidden rounded-2xl border border-gray-200/90 bg-white shadow-sm ring-1 ring-primary-900/5">
        ...
        <div className="px-4 py-4 sm:px-6 sm:py-5">
          <p className="text-[11px] font-semibold uppercase tracking-wider text-gray-500">Demirbaş belgeleri</p>
          <h1 className="mt-1 break-words text-xl font-semibold tracking-tight text-gray-900 sm:text-2xl">{assetTitle}</h1>
        </div>
      </div>
